...
class OrderResponse:
    def __init__(self, orderId, symbol, status, message, uniqueOrderId = None):
    ...
    def __repr__(self):
        return f"OrderResponse(orderId={self.orderId}, symbol={self.symbol}, status={self.status}, message={self.message}, uniqueOrderId={self.uniqueOrderId})"
